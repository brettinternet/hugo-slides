...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/reveal.js/plugin/markdown/marked.js":[function(require,module,exports) {
var define;
...
!function (e) {
  ...
  function a(e) {
    this.tokens = [], this.tokens.links = Object.create(null), this.options = e || m.defaults, this.rules = k.normal, this.options.pedantic ? this.rules = k.pedantic : this.options.gfm && (this.options.tables ? this.rules = k.tables : this.rules = k.gfm);
  }
    ...
    for (e = e.replace(/^ +$/gm, ""); e;) {
      if ((s = this.rules.newline.exec(e)) && (e = e.substring(s[0].length), 1 < s[0].length && this.tokens.push({
        ...
        for (e = e.substring(s[0].length), a = {
          ...
          start: d ? +i : "",
          loose: !1
        }, this.tokens.push(a), n = !(h = []), f = (s = s[0].match(this.rules.item)).length, c = 0; c < f; c++) {
  ...
  n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", n.em = i(n.em).replace(/punctuation/g, n._punctuation).getRegex(), n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, n.autolink = i(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = i(n.tag).replace("comment", k._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, n._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f\\]*\)|[^\s\x00-\x1f()\\])*?)/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = i(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = i(n.reflink).replace("label", n._label).getRegex(), n.normal = d({}, n), n.pedantic = d({}, n.normal, {
    ...
    this.inline = new h(e.links, this.options), this.inlineText = new h(e.links, d({}, this.options, {
      renderer: new s()
  ...
  function m(e, n, r) {
    ...
    if (r || "function" == typeof n) {
      ...
      if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (n || m.defaults).silent) return "<p>An error occurred:</p><pre>" + u(e.message + "", !0) + "</pre>";
      throw e;
    }
  }
  ...
  }, m.defaults = m.getDefaults(), m.Parser = p, m.parser = p.parse, m.Renderer = r, m.TextRenderer = s, m.Lexer = a, m.lexer = a.lex, m.InlineLexer = h, m.inlineLexer = h.output, m.Slugger = t, m.parse = m, "undefined" != typeof module && "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = m : "function" == typeof define && define.amd ? define(function () {
    return m;
  }) : e.marked = m;
}(this || ("undefined" != typeof window ? window : global));
},{}],"../../../../Users/zorak/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../Users/zorak/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../../node_modules/reveal.js/plugin/markdown/marked.js"], null)
//# sourceMappingURL=/marked.ee716a1a.js.map